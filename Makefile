...
ifeq ($(UNAME_S),Darwin)
  VSAG_CMAKE_ARGS := ${VSAG_CMAKE_ARGS} -DENABLE_LIBCXX=ON -DENABLE_WERROR=OFF -DENABLE_LIBAIO=OFF -DUSE_SYSTEM_OPENBLAS=ON -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++
endif
