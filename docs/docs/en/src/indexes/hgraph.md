...
| `max_duplicates_per_group` | int | `-1` | Maximum duplicate members to expand per group during standard and iterator KNN bottom-graph traversal. `-1` means unlimited; `0` disables duplicate expansion. |
